...
namespace smart_pet_care_api.Modules.JournalModule.Domain
{
    ...
    {
        Task<IReadOnlyList<JournalEntryResponseDto>> GetByPetIdAsync(Guid petId, Guid userId, JournalEntryType? type, JournalEntrySeverity? severity, DateTime? from, DateTime? to);
