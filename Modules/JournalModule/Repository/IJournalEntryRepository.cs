...
namespace smart_pet_care_api.Modules.JournalModule.Repository
{
    public interface IJournalEntryRepository
    {
        ...
        Task<IReadOnlyList<JournalEntry>> GetByPetIdAsync(Guid petId, JournalEntryType? type, JournalEntrySeverity? severity, SymptomType? symptom, DateTime? from, DateTime? to);
